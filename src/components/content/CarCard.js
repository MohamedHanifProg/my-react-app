...
function CarCard() {
  ...
  // Duplicate the first 3 cars to create 12 cards
  useEffect(() => {
    const firstThreeCars = carsData.slice(0, 3); // Get the first 3 cars
    const duplicatedCars = [...carsData, ...firstThreeCars]; // Add them to the end
    setCars(duplicatedCars); // Set the cars state with 12 cards
  }, []);
          ...
          <div key={car.id} className="catalog-card">
            ...
            <div className="vuesax">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                fill={car.isFavorite ? "#ED3F3F" : "none"}
                stroke="#ED3F3F"
                strokeWidth="2"
                strokeLinecap="round"
            ...
            <div className="specification">
              <div className="specification-gasoline">
                ...
                <div className="specification-gasoline-text">{car.gasoline}</div>
              </div>
              ...
              <div className="specification-car">
                ...
                <div className="specification-car-text">{car.transmission}</div>
              </div>
