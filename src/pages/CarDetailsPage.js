...
function CarDetails() {
    ...
    const carImage = selectedCar?.images?.[0] || "/assets/default.jpg";
            ...
            <div className="car-details-content">
                ...
                <div className="car-details-main">
                    ...
                    <div className="view1-container">
                        <div className="view-1">
                            <div className="stroke">
                                <div className="view-1-1">
                                    <svg className="bg" xmlns="http://www.w3.org/2000/svg" width="132" height="108" viewBox="0 0 132 108" fill="none">
                                        <path d="M0.9802 69L-5.21216 54H0.9802H7.17256L13.3649 69L7.17256 84H0.9802H-5.21216L0.9802 69Z" fill="white" fillOpacity="0.06" />
                                    </svg>
                                    <img
                        ...
                        <div className="view-2">
                            <img
                                src={selectedCar?.images?.[3] || "/assets/View2.png"}
                                alt="View 2"
                                onError={(e) => { e.target.src = "/assets/default.jpg"; }}
                            />
                        </div>
                        ...
                        <div className="view-3">
                            <img
                                src={selectedCar?.images?.[3] || "/assets/View3.png"}
                                alt="View 3"
                                onError={(e) => { e.target.src = "/assets/default.jpg"; }}
                            />
                        </div>
                ...
                <div className="detailcar-container">
                    <div className="car-name-detail">
                        ...
                        <div className="vuesax-heart-container" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M16.44 3.10001C14.63 3.10001 13.01 3.98001 12 5.33001C10.99 3.98001 9.37 3.10001 7.56 3.10001C4.49 3.10001 2 5.60001 2 8.69001C2 9.88001 2.19 10.98 2.52 12C4.1 17 8.97 19.99 11.38 20.81C11.72 20.93 12.28 20.93 12.62 20.81C15.03 19.99 19.9 17 21.48 12C21.81 10.98 22 9.88001 22 8.69001C22 5.60001 19.51 3.10001 16.44 3.10001Z" fill="#ED3F3F" />
                            </svg>
                        </div>
